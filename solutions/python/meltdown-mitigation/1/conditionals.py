...
def is_criticality_balanced(temperature, neutrons_emitted):
    ...
    # Check all three conditions for reactor to be critical
    return (
        temperature < 800 and
...
def reactor_efficiency(voltage, current, theoretical_max_power):
    ...
    # Calculate power actually generated by the reactor
    generated_power = voltage * current

    # Calculate efficiency as a percentage
    efficiency_percentage = (generated_power / theoretical_max_power) * 100

    # Determine and return efficiency zone based on percentage
...
def fail_safe(temperature, neutrons_produced_per_second, threshold):
    ...
    # Calculate the reactor's criticality metric
    criticality = temperature * neutrons_produced_per_second

    # Define the safe zone range
    lower_bound = 0.9 * threshold
    upper_bound = 1.1 * threshold

    # Check which status the criticality value falls into
